...
class Ui_timeline_window(object):
    def setupUi(self, timeline_window):
        ...
        timeline_window.resize(951, 477)
        self.centralwidget = QtGui.QWidget(timeline_window)
        ...
        self.canvas.setGeometry(QtCore.QRect(0, 0, 936, 200))
        ...
        spacerItem = QtGui.QSpacerItem(200, 0, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem1 = QtGui.QSpacerItem(15, 0, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.verticalLayout.addLayout(self.horizontalLayout)
        timeline_window.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(timeline_window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 951, 22))
        self.menubar.setObjectName("menubar")
        timeline_window.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(timeline_window)
        ...
        timeline_window.setStatusBar(self.statusbar)
